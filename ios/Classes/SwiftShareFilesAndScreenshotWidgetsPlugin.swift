...
public class SwiftShareFilesAndScreenshotWidgetsPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "channel:share_files_and_screenshot_widgets", binaryMessenger: registrar.messenger())
        let instance = SwiftShareFilesAndScreenshotWidgetsPlugin()
